...
//        progressBar.setProgress((int) apkApi.getReadLength());
        ...
        if (apkApi.getReadLength() != 0 && apkApi.getCountLength() != 0)
            progressBar.setProgress((int) (((float) apkApi.getReadLength() / (float) apkApi.getCountLength()) * 100));
        /*第一次恢复 */
    ...
    HttpDownOnNextListener<DownInfo> httpProgressOnNextListener = new HttpDownOnNextListener<DownInfo>() {
        ...
        public void updateProgress(long readLength, long countLength) {
            ...
            progressBar.setMax(100);
//            progressBar.setProgress((int) (readLength / countLength));
            progressBar.setProgress((int) (((float) readLength / (float) countLength) * 100));
